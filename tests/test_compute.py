...
def test_compute(settings, client, fake_auth, hydrogen, engine, model, keywords, group):
    ...
    def test_compute_group_limits(
        ...
        too_big_list = [atomic_input] * (settings.max_group_inputs + 1)
        ...
        assert (
            job_submission.status_code == status_codes.HTTP_413_REQUEST_ENTITY_TOO_LARGE
        )
    ...
    def test_compute_procedure_group_limits(
        ...
        too_big_list = [optimization_input] * (settings.max_group_inputs + 1)
